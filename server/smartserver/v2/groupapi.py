...
def accountActionBeforeLogin():
    ...
    @type data:JSON
    @param data:{'action': 'register', 'data':{'username':(string)username, 'password':(string)password, 'appid':(string)appid,'info':{'email':(string), 'telephone':(string)telephone, 'company':(string)company}}
    @rtype: JSON
    ...
    @type data:JSON
    @param data:{'action': 'forgotpasswd', 'data':{'email':(string)mailaddress}}
    @rtype: JSON
    @return: ok-{'results':'ok', 'data':{}, 'msg': ''}
             error-{'results':'error', 'data':{'code':(string)code}, 'msg': '(string)info'}
    ...
    @type data:JSON
    @param data:{'action': 'login', 'data': {'appid':(int)appid, 'username':(string)username, 'password':(string)password}}
    @rtype: JSON
    @return: ok-{'results':'ok', 'data':{'token':(string)value}, 'msg': ''}
             error-{'results':'error', 'data':{'code':(string)code}, 'msg': '(string)info'}
    """
    return doAccountActionBeforeLogin(request.json)
...
def accountActionAfterLogin():
    ...
    @type data:JSON
    @param data:{'action': 'changepasswd', 'data':{'token':(string)token,'oldpassword':(string)oldpassword, 'newpassword':(string)newpassword }}
    @rtype: JSON
    @return: ok-{'results':'ok', 'data':{}, 'msg': ''}
             error-{'results':'error', 'data':{'code':(string)code}, 'msg': '(string)info'}
    ...
    @type data:JSON
    @param data:{'action': 'update', 'data': {'token':(string)token,'info':{'email':(string), 'telephone':(string)telephone, 'company':(string)company}}}
    @rtype: JSON
    @return: ok-{'results':'ok', 'data':{}, 'msg': ''}
             error-{'results':'error', 'data':{'code':(string)code}, 'msg': '(string)info'}
    ...
    @type data:JSON
    @param data:{'action': 'invite', 'data': {'token':(string)token, 'email':(string)email}}
    @rtype: JSON
    @return: ok-{'results':'ok', 'data':{}, 'msg': ''}
             error-{'results':'error', 'data':{'code':(string)code}, 'msg': '(string)info'}
    ...
    @type data:JSON
    @param data:{'action': 'logout', 'data': {'token':(string)token}}
    @rtype: JSON
    @return: ok-{'results':'ok', 'data':{}, 'msg': ''}
             error-{'results':'error', 'data':{'code':(string)code}, 'msg': '(string)info'}
    ...
    """
    return "123"
    #return doAccountActionAfterLogin(uid, request.json)
...
def accountActionGet():
    ...
    @rtype: JSON
    @return: ok-{'results':'ok', 'data':{'count':(int)value, 'users':[{'uid':(string)uid,'username':(string)username},{'uid':(string)uid,'username':(string)username}]}}, 'msg': ''}
             error-{'results':'error', 'data':{'code':(string)code}, 'msg': '(string)info'}

    Get information of user
    @type data:JSON
    @param data:{'action': 'info', 'data':{}}
    @rtype: JSON
    @return: ok-{'action': 'info', 'data': {'username':(string)username,'inGroups':[{'gid':gid1,'groupname':(string)name1},{'gid':gid2,'groupname':(string)name2},...],'info':{'email':(string)email, 'telephone':(string)telephone, 'company':(string)company}}}
             error-{'results':'error', 'data':{'code':(string)code}, 'msg': '(string)info'}
    """
    return doAccountActionGet(uid, request.params)
